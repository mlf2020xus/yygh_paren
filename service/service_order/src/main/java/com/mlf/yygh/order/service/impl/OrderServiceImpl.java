...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, OrderInfo> implements OrderService {
   ...
   private RabbitService rabbitService;
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        orderInfo.setOrderStatus(OrderStatusEnum.UNPAID.getStatus());//预约成功待支付状态
        //this.save(orderInfo);
        baseMapper.insert(orderInfo);//同this.save(orderInfo)
        ...
        //请求医院系统中的接口  HttpRequestHelper工具类
        ...
        if(result.getInteger("code") == 200) {
            ...
            //发送mq信息，更新号源和短信通知
            //使用MQ目的：数量更新到表里面去，再跟联系人发送手机短信，说号源已经预约成功了
            //发送mq信息更新号源
            ...
            //mq的发送  三个参数分别是交换机  路由键  消息体   通过mq实现数量的更新和短信的发送
    ...
    public void patientTips() {
        ...
        for(OrderInfo orderInfo : orderInfoList) {
            ...
            MsmVo msmVo = new MsmVo();
            msmVo.setPhone(orderInfo.getPatientPhone());
            String reserveDate = new DateTime(orderInfo.getReserveDate())
